...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $shop = [
            'id' => 1,
            'name' => '仙人',
            'img_pass' => 'http://127.0.0.1:8000/storage/仙人.jpg',
        ...
        $shop = [
            'id' => 2,
            'name' => '牛助',
            'img_pass' => 'http://127.0.0.1:8000/storage/牛助.jpeg',
        ...
        $shop = [
            'id' => 3,
            'name' => '戦慄',
            'img_pass' => 'http://127.0.0.1:8000/storage/戦慄.jpeg',
        ...
        $shop = [
            'id' => 4,
            'name' => 'ルーク',
            'img_pass' => 'http://127.0.0.1:8000/storage/ルーク.jpeg',
        ...
        $shop = [
            'id' => 5,
            'name' => '志摩屋',
            'img_pass' => 'http://127.0.0.1:8000/storage/志摩屋.jpeg',
        ...
        $shop = [
            'id' => 6,
            'name' => '香',
            'img_pass' => 'http://127.0.0.1:8000/storage/香.jpeg',
        ...
        $shop = [
            'id' => 7,
            'name' => 'JJ',
            'img_pass' => 'http://127.0.0.1:8000/storage/JJ.jpeg',
        ...
        $shop = [
            'id' => 8,
            'name' => 'らーめん極み',
            'img_pass' => 'http://127.0.0.1:8000/storage/らーめん極み.jpeg',
        ...
        $shop = [
            'id' => 9,
            'name' => '鳥雨',
            'img_pass' => 'http://127.0.0.1:8000/storage/鳥雨.jpeg',
        ...
        $shop = [
            'id' => 10,
            'name' => '築地色合',
            'img_pass' => 'http://127.0.0.1:8000/storage/築地色合.jpeg',
        ...
        $shop = [
            'id' => 11,
            'name' => '晴海',
            'img_pass' => 'http://127.0.0.1:8000/storage/晴海.jpeg',
        ...
        $shop = [
            'id' => 12,
            'name' => '三子',
            'img_pass' => 'http://127.0.0.1:8000/storage/三子.jpeg',
        ...
        $shop = [
            'id' => 13,
            'name' => '八戒',
            'img_pass' => 'http://127.0.0.1:8000/storage/八戒.jpeg',
        ...
        $shop = [
            'id' => 14,
            'name' => '福助',
            'img_pass' => 'http://127.0.0.1:8000/storage/福助.jpeg',
        ...
        $shop = [
            'id' => 15,
            'name' => 'ラー北',
            'img_pass' => 'http://127.0.0.1:8000/storage/ラー北.jpeg',
        ...
        $shop = [
            'id' => 16,
            'name' => '翔',
            'img_pass' => 'http://127.0.0.1:8000/storage/翔.jpeg',
        ...
        $shop = [
            'id' => 17,
            'name' => '経緯',
            'img_pass' => 'http://127.0.0.1:8000/storage/経緯.jpeg',
        ...
        $shop = [
            'id' => 18,
            'name' => '漆',
            'img_pass' => 'http://127.0.0.1:8000/storage/漆.jpeg',
        ...
        $shop = [
            'id' => 19,
            'name' => 'THE TOOL',
            'img_pass' => 'http://127.0.0.1:8000/storage/THE TOOL.jpeg',
        ...
        $shop = [
            'id' => 20,
            'name' => '木船',
            'img_pass' => 'http://127.0.0.1:8000/storage/木船.jpeg',
